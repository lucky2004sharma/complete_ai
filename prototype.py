...
def encode_once(
    ...
    if output_format in {"JPG", "JPEG"}:
        ...
        # समस्या (OLD CODE): यहाँ सिर्फ एक स्थिर तस्वीर सेव की जा रही थी। एक फोटो में मोशन नहीं होता, इसलिए वह 3-4 सेकंड का वीडियो या GIF नहीं बनता था।
        # save_options.update(optimize=True)
        
        # समाधान (NEW CODE): आपकी बात बिल्कुल सही है! हमने उसी सिंगल फोटो की 30 कॉपी (frames) बना दी हैं। 30 फ्रेम * 100ms = 3 सेकंड का 'Animated GIF' तैयार होगा, जो हमेशा लूप (loop=0) करेगा।
        frames_to_animate = [image_to_save] * 30
        save_options.update(
            optimize=True,
            save_all=True,
            append_images=frames_to_animate[1:],
...
def create_app() -> Any:
    ...
    def resize_or_convert() -> Any:
        ...
        # yahan par python ka backend work hota hain.
